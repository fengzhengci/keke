...
lockfile = '/tmp/mdeth.lock'
ldd_file = '/data/linkdood/im/conf/liandoudou.conf'
serverip =  {
      "isOuter": False,
      "inner": {
        "ip": "",
...
def md_pre_cfg(cfg="/data/linkdood/im/vrv/prelogin/apinfo.json"):
    pass
...
def get_ldd_info(cfg=ldd_file):
    ...
    inip = src_conf.get('inip')
    outip = src_conf.get('outip')
    eurl = src_conf.get('eurl')
